...
/* eslint-disable */
export const Particles = (function (t, e) {
  let n;
  let i = {};
  function o(t, e) {
  ...
  return (
    ((n = (function () {
      ...
      const e = this;
      return (
        (e.options = e._extend(e.defaults, t)),
        (e.originalSettings = JSON.parse(JSON.stringify(e.options))),
        (e._animate = e._animate.bind(e)),
        e._initializeCanvas(),
        e._initializeEvents(),
        e._registerBreakpoints(),
        e._checkResponsive(),
        e._initializeStorage(),
        e._animate(),
        e
      );
    }),
    (n.prototype.destroy = function () {
      ...
      (e.storage = []),
        e.element.remove(),
        t.removeEventListener('resize', e.listener, !1),
        t.clearTimeout(e._animation),
        cancelAnimationFrame(e._animation);
    }),
    (n.prototype._initializeCanvas = function () {
      ...
      (o.element = e.querySelector(o.options.selector)),
        ...
        (i =
          ...
          1),
        (o.ratio = n / i),
        (o.element.width = o.element.offsetParent.clientWidth * o.ratio),
        o.element.offsetParent.nodeName === 'BODY'
          ? (o.element.height = t.innerHeight * o.ratio)
          : (o.element.height = o.element.offsetParent.clientHeight * o.ratio),
    ...
    (n.prototype._initializeEvents = function () {
      ...
      (e.listener = function () {
        ...
        t.addEventListener('resize', e.listener, !1);
    }),
    (n.prototype._initializeStorage = function () {
      const t = this;
      t.storage = [];
      for (let e = t.options.maxParticles; e--; )
    ...
    (n.prototype._registerBreakpoints = function () {
      ...
      let n;
      const i = this;
      const o = i.options.responsive || null;
    ...
    (n.prototype._checkResponsive = function () {
      ...
      if (
        ...
        n.options.responsive !== null
      ) {
        for (e in ((i = null), n.breakpoints))
          n.breakpoints.hasOwnProperty(e) &&
            o <= n.breakpoints[e] &&
            (i = n.breakpoints[e]);
        i !== null
    ...
    (n.prototype._resize = function () {
      const e = this;
      (e.element.width = e.element.offsetParent.clientWidth * e.ratio),
        e.element.offsetParent.nodeName === 'BODY'
          ? (e.element.height = t.innerHeight * e.ratio)
          : (e.element.height = e.element.offsetParent.clientHeight * e.ratio),
        e.context.scale(e.ratio, e.ratio),
        clearTimeout(e.windowDelay),
        (e.windowDelay = t.setTimeout(function () {
    ...
    (n.prototype._draw = function () {
      const e = this;
      const n = e.element;
      const i = n.offsetParent.clientWidth;
      let r = n.offsetParent.clientHeight;
      const a = e.options.showParticles;
      const s = e.storage;
      n.offsetParent.nodeName === 'BODY' && (r = t.innerHeight),
    ...
    (n.prototype._drawEdge = function (t, e, n) {
      const i = this;
      const o = i.context.createLinearGradient(t.x, t.y, e.x, e.y);
      const r = this._hex2rgb(t.color);
      const a = this._hex2rgb(e.color);
      o.addColorStop(0, `rgba(${r.r},${r.g},${r.b},${n})`),
        o.addColorStop(1, `rgba(${a.r},${a.g},${a.b},${n})`),
        i.context.beginPath(),
        (i.context.strokeStyle = o),
        i.context.moveTo(t.x, t.y),
        i.context.lineTo(e.x, e.y),
        i.context.stroke(),
        i.context.fill(),
        i.context.closePath();
    }),
    ...
    ((i = function (n, i) {
      ...
      const l = e.querySelector(i.selector);
      (o.x = r() * l.offsetParent.clientWidth),
        l.offsetParent.nodeName === 'BODY'
          ? (o.y = r() * t.innerHeight)
          : (o.y = r() * l.offsetParent.clientHeight),
        (o.vx = r() * a * 2 - a),
        (o.vy = r() * a * 2 - a),
      ...
      const t = this;
      t.context.save(),
        t.context.translate(t.x, t.y),
        t.context.moveTo(0, 0),
        t.context.beginPath(),
        t.context.arc(0, 0, t.radius, 0, 2 * Math.PI, !1),
    ...
    (i.prototype._updateCoordinates = function (t, e) {
      ...
      let o = n.y + this.vy;
      const r = n.radius;
      i + r > t ? (i = r) : i - r < 0 && (i = t - r),
        o + r > e ? (o = r) : o - r < 0 && (o = e - r),
        (n.x = i),
        (n.y = o);
    }),
